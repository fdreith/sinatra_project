...
Event.create(pet_id: 1, event_type: "Feed", details: "2 cups", owner_id: 4)
Event.create(pet_id: 2, event_type: "Feed", details: "2 cups", owner_id: 3)
Event.create(pet_id: 3, event_type: "Feed", details: "2 cups", owner_id: 2)
